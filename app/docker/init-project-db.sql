...
--
-- TOC entry 2903 (class 0 OID 16451)
-- Dependencies: 203
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: -
--
-- INSERT INTO users
--     VALUES ('U1', 'nils', 'Nils Hartmann');
-- INSERT INTO users
--     VALUES ('U2', 'susi', 'Susi Mueller');
-- INSERT INTO users
--     VALUES ('U3', 'klaus', 'Klaus Schneider');
-- INSERT INTO users
--     VALUES ('U4', 'sue', 'Sue Taylor');
-- INSERT INTO users
--     VALUES ('U5', 'lauren', 'Lauren Jones');
-- INSERT INTO users
--     VALUES ('U6', 'olivia', 'Olivia Smith');
-- INSERT INTO users
--     VALUES ('U7', 'cathy', 'Cathy Brown');
-- INSERT INTO users
--     VALUES ('U8', 'maja', 'Maja Walsh');
-- INSERT INTO users
--     VALUES ('U9', 'helvia', 'Helvia Fernandez');

SELECT
  pg_catalog.setval('category_id_seq', 8050, TRUE);

SELECT
  pg_catalog.setval('project_id_seq', 51, TRUE);

SELECT
  pg_catalog.setval('task_id_seq', 2050, TRUE);
...
ALTER TABLE ONLY projects
  ADD CONSTRAINT fk4sld861xurfwb6axyscs4x304 FOREIGN KEY (category_id) REFERENCES categories (id);
